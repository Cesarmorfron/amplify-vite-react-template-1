...
const LegalNotice: React.FC = () => {
  return (
    <div className="legal-notice-container">
      ...
      <section className="contact-handling">
        ...
        <p>
          La titularidad de este sitio web, www.esquelaelectroncia.com, (en
          adelante, Sitio Web) la ostenta: Cesar Morillo, con NIF: 71031730W, y
      ...
      <section className="contact-handling">
        ...
        <p>
          ...
          Condiciones) es regular el acceso y la utilización del Sitio Web. A
          los efectos de las presentes Condiciones se entenderá como Sitio Web:
          la apariencia externa de los interfaces de pantalla, tanto de forma
          estática como de forma dinámica, es decir, el árbol de navegación; y
          todos los elementos integrados tanto en los interfaces de pantalla
          como en el árbol de navegación (en adelante, Contenidos) y todos
          aquellos servicios o recursos en línea que en su caso ofrezca a los
          Usuarios (en adelante, Servicios).
        </p>
        <p>
          Esquela Electronica se reserva la facultad de modificar, en cualquier
          ...
          Esquela Electronica pueda interrumpir, desactivar y/o cancelar
          cualquiera de estos elementos que se integran en el Sitio Web o el
          acceso a los mismos.
        </p>
        <p>
          Aparte del coste de conexión a través de la red de telecomunicaciones
          suministrada por el proveedor de acceso, y que hubiere contratado el
          Usuario, algunos de los Contenidos o Servicios ofrecidos por Esquela
          Electronica o, en su caso, terceros a través del Sitio Web pueden
          encontrarse sujetos a la contratación previa del Contenido o Servicio,
          en cuyo caso se especificará de forma clara y/o se pondrá a
          disposición del Usuario las correspondientes Condiciones Generales o
      ...
      <section className="contact-handling">
        ...
        <p>
          El Sitio Web de Esquela Electronica proporciona gran diversidad de
        ...
        <p>
          ...
          por Esquela Electronica sin que sea contrario a lo dispuesto por las
        ...
        <p>
          ...
          en los formularios extendidos por Esquela Electronica para el acceso a
          ciertos Contenidos o Servicios ofrecidos por el Sitio Web. En todo
          caso, el Usuario notificará de forma inmediata a Esquela Electronica
        ...
        <p>
          ...
          relación de carácter comercial entre Esquela Electronica y el Usuario.
        </p>
        <p>
          Siempre en el respeto de la legislación vigente, este Sitio Web de
          Esquela Electronica se dirige a todas las personas, sin importar su
          edad, que puedan acceder y/o navegar por las páginas del Sitio Web.
        </p>
      </section>
      <section className="contact-handling">
        <h2>
        ...
        <p>
          Esquela Electronica no garantiza la continuidad, disponibilidad y
          utilidad del Sitio Web, ni de los Contenidos o Servicios. Esquela
          Electronica hará todo lo posible por el buen funcionamiento del Sitio
          Web, sin embargo, no se responsabiliza ni garantiza que el acceso a
        ...
        <p>
          ...
          Usuario. En ningún caso Esquela Electronica será responsable por las
        ...
        <p>
          Esquela Electronica tampoco se hace responsable de los daños que
          pudiesen ocasionarse a los usuarios por un uso inadecuado de este
          Sitio Web. En particular, no se hace responsable en modo alguno de las
          caídas, interrupciones, falta o defecto de las telecomunicaciones que
          pudieran ocurrir.
        </p>
      </section>
      ...
      <section className="contact-handling">
        ...
        <p>
          ...
          de otro, distinto, sitio web al Sitio Web de Esquela Electronica
          deberá saber que:
        </p>
        <p>
        ...
        <p>
          ...
          incorrecta sobre el Sitio Web de Esquela Electronica, ni sobre los
        ...
        <p>
          ...
          español, salvo autorización expresa de Esquela Electronica.{' '}
        </p>
        <p>
          El establecimiento del hipervínculo no implicará la existencia de
          relaciones entre Esquela Electronica y el titular del sitio web desde
          el cual se realice, ni el conocimiento y aceptación de Esquela
          Electronica de los contenidos, servicios y/o actividades ofrecidas en
      ...
      <section className="contact-handling">
        ...
        <p>
          Esquela Electronica por sí o como parte cesionaria, es titular de
          todos los derechos de propiedad intelectual e industrial del Sitio
          Web, así como de los elementos contenidos en el mismo (a título
          enunciativo y no exhaustivo, imágenes, sonido, audio, vídeo, software
          o textos, marcas o logotipos, combinaciones de colores, estructura y
          diseño, selección de materiales usados, programas de ordenador
          necesarios para su funcionamiento, acceso y uso, etc.). Serán, por
          consiguiente, obras protegidas como propiedad intelectual por el
          ordenamiento jurídico español, siéndoles aplicables tanto la normativa
        ...
        <p>
          ...
          cualquier medio técnico, sin la autorización de Esquela Electronica.
        </p>
        <p>
          El Usuario se compromete a respetar los derechos de propiedad
          intelectual e industrial de Esquela Electronica. Podrá visualizar los
        ...
        <p>
          ...
          inmediatamente a Esquela Electronica a través de los datos de contacto
          del apartado de INFORMACIÓN GENERAL de este Aviso Legal y Condiciones
          Generales de Uso.
        </p>
      </section>
      ...
      <section className="contact-handling">
        ...
        <p>
          Esquela Electronica se reserva la facultad de presentar las acciones
        ...
        <p>
          La relación entre el Usuario y Esquela Electronica se regirá por la
        ...
        <p>
          ...
          condiciones de uso online el día 21/09/2024.
        </p>
      </section>

      <section className="contact-handling">
        <h2>Manejo de Contactos</h2>
        <p>
          En Esquela Electrónica, nos tomamos muy en serio la privacidad de los
          datos. Al agregar contactos (emails) de sus seres queridos, usted
          autoriza el uso de esta información exclusivamente para notificaciones
          relacionadas con el fallecimiento del usuario.
        </p>
        <p>
          Si alguno de los contactos desea no recibir estas notificaciones,
          puede enviarnos un correo a
          <a href="mailto:notificaciones@esquelainformatica.com">
            {' '}
            notificaciones@esquelainformatica.com
          </a>
          , y lo agregaremos a nuestra lista negra, asegurando que no reciba más
          correos de nuestra parte.
        </p>
        <p>
          Solo enviaremos correos electrónicos a los contactos proporcionados
          cuando el usuario fallezca, y no realizaremos envíos adicionales.
        </p>
      </section>
    </div>
  );
